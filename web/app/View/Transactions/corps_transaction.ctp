	...
	<div>
		<ul id="barreProgress" class="step-5">	
			...
			<li class="etape <?php if($step_for_progress_bar == 2)echo 'focus'; ?>">
				<span>2</span><h1> - Dépôt</h1><p>Liste des livres à déposer</p>
			</li>
			<li class="etape <?php if($step_for_progress_bar == 3)echo 'focus'; ?>">
				<span>3</span><h1> - Recapitulation</h1><p>Liste des livres déposer</p>
			</li>
		...
		<div id="btnGroup">
			<a id="btnPred" class="btn btn-primary " href="#"><span class="glyphicon glyphicon-chevron-left"></span> Pred</a>
