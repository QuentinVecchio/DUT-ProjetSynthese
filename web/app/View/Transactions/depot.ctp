...
<section id="book_choice" ng-show="clicked" ng-init="clicked=false" class="container animated fadeIn" style="clear:both;">
        <header id="header" ng-init="transaction_id='<?php echo $this->Session->read('Transaction.depot.transaction_id') ?>';etats=<?php echo htmlentities(json_encode($listCondition)); ?>;">
          ...
          <div ng-init="urlGetBooks='<?php echo $this->Html->url(array('controller' =>'transactions', 'action' => 'getBooksDepot', 'full_base' => true)) ?>'"></div>
