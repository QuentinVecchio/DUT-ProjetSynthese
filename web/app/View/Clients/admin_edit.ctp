		...
		<fieldset ng-init="urlTown='<?php echo $this->Html->url(array('controller' => 'towns', 'action' => 'getTown', 'admin' => false)) ?>'">
			...
			<div class="form-group">
				<div class="classForm corpsForm">
					...
					<select class="form-control input-sm" style="width:164px; margin-left:100px;" ng-model="Associations.Association.town_id" ng-init="initTown2()" name="town_id" ng-options="value.Town.name for value in villes track by value.Town.id" ng-change="updateZipCode2()" required></select>
				</div>
			</div>
